...
upstream master. They were found while investigating the client freezes reported in September 2026,
after Courtney Wildman's laptop stopped logging entirely at the point its log file crossed the 50MB
rotation threshold.
...
**Not yet submitted upstream.** Belledonne accept neither GitHub pull requests nor patches against
old releases, so this needs forward-porting from tag 5.4.114 to master and a signed contributor
