...
public:
	...
	// Our own quieter replacements for the SDK's synthesised tones, installed alongside its sounds.
	// Generated by Linphone/data/sound/generate-tones.py.
	static constexpr char CallWaitingToneFile[] = "nmpbx-call-waiting.wav";
	static constexpr char CallOnHoldToneFile[] = "nmpbx-call-on-hold.wav";
	// Registered in place of either tone when the user turns it off in settings.
	static constexpr char SilentToneFile[] = "nmpbx-silence.wav";
